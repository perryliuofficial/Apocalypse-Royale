...
if global.rescue = true {
	...
	if point_distance(closestsupply.x, closestsupply.y, ofinalmission.x, ofinalmission.y)+distance_to_object(closestsupply) <=distance_to_object(ofinalmission)+200{
		move_towards_point(closestsupply.x,closestsupply.y,speed);
		action="Locating Supplies";
	} else {move_towards_point(ofinalmission.x,ofinalmission.y,speed);action="Extracting";}
	}
