...
if global.win = true and global.TVscore >= 100000{
...
draw_set_color(c_white);
draw_text_ext(190+82,10,"The military has authorised bombing runs along the old motorway. Use it to your advantage.",15,700);
