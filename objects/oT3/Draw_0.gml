...
draw_set_color(c_white);
draw_text_ext(190+82,10,"Humans and zombies alike have a limited visibility range, so you can drop temporary beacons to nudge their movements. Not everyone will necessarily respond, however.",15,700);
